...
//
//public class OldClientHandler implements Runnable {
//    private final Socket socket;
//    private final DocsManager docsManager;
//    private static final Logger logger = Logger.getLogger(OldClientHandler.class.getName());
//
//    private BufferedReader in;
//    private PrintWriter out;
//
//    public OldClientHandler(Socket socket, DocsManager docsManager) {
//        this.socket = socket;
...
//    }
//
//    public void grantWritePermission(Path sectionPath) {
...
//        }
//
//        boolean isAvailable = SectionLockManager.getInstance()
//                .requestLock(sectionPath, this);
//
//        if (!isAvailable) {
...
//            SectionLockManager.getInstance()
//                    .releaseLock(sectionPath);
//        }
//    }
//}
